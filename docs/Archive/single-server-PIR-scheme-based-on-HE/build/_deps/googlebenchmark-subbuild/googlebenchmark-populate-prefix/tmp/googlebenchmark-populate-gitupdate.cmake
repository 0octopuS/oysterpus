...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "D:/Applications/Git/cmd/git.exe" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "D:/Applications/Git/cmd/git.exe" show-ref "v1.7.1"
  WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "D:/Applications/Git/cmd/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "D:/Applications/Git/cmd/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "D:/Applications/Git/cmd/git.exe" for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
...
execute_process(
  COMMAND "D:/Applications/Git/cmd/git.exe" status --porcelain
  WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "D:/Applications/Git/cmd/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "D:/Applications/Git/cmd/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "D:/Applications/Git/cmd/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "D:/Applications/Git/cmd/git.exe" rebase --abort
      WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "D:/Applications/Git/cmd/git.exe" stash pop --index --quiet
          WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src'."
    ...
    execute_process(
      COMMAND "D:/Applications/Git/cmd/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "D:/Applications/Git/cmd/git.exe" reset --hard --quiet
      WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
    )
    execute_process(
      COMMAND "D:/Applications/Git/cmd/git.exe" stash pop --quiet
      WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "D:/Applications/Git/cmd/git.exe" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
      )
      execute_process(
        COMMAND "D:/Applications/Git/cmd/git.exe" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "D:/Applications/Git/cmd/git.exe" submodule update --recursive --init 
    WORKING_DIRECTORY "E:/5.paper/code/xzxpir/build/_deps/googlebenchmark-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
